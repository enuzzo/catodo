...
- **Featured:** all 305 works from the editorial research, with twelve thematic collections, Music/War genres, filmmaker/story search, language filters and editorial/year/title ordering. Browse 24 entries at a time, enable credited source images, and open full synopses, historical context and edition notes in a dismissible popup. Sources open externally; research inclusion does not approve an edition for the in-app player.
