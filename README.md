...
- **Theatre:** a compact film shelf with Randomize, six editorial collections, synopsis excerpts, readable image credits and optional Ken Burns galleries. The persistent video expands after **Allow source & play**; no film loads before consent. Favorites, genre, collection, language and search filters combine. Credits include edition notes, source/license links and a local source QR. The [current register](docs/work/2026-09-22-theatre-register.md) contains 29 reviewed works and 37 editions/episodes; the 50-work selection and classic-cinema edition checks remain open.
