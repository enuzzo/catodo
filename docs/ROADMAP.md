...
| UX-04 | Ordering and Featured editorial facets implemented | Theatre discovery by era, year, editorial theme, duration and language, with useful sorting | Curated Order by: editorial, year ascending/descending, title and shortest duration. Reconcile existing archive decade/review filters before adding facets. Keep genres, eras and overlapping editorial collections distinct; verify original release years and missing values. Compact progressive controls in both Tesla viewports; see [handoff](work/2026-09-22-claude-featured-handoff.md) |
...
| UX-06 | Included in 2.13.0 release | Subtle 4–6 px corners on remaining square surfaces and consistent dropdown spacing | Shared CSS treatment, joined panel seams and artwork clipping; Multiview preset/action reachability. See the [verification contract](TESTING.md#shared-corners-and-dropdowns). Claude editorial intake remains separate |
| UX-07 | Included in 2.13.0 release | Align six Home suggestions with the preview and restore spacious favorite rows | Up to 18 favorites; More opens the full favorite Library. Six columns on wide layouts, three on compressed Tesla and two on phone. [Verification](TESTING.md#home-alignment-and-favorite-limits) |
